...
dframe1=pd.read_csv("dataset/test.csv",header=0,skiprows=0,engine='python')
...
delete_columns =['admission_type_id','discharge_disposition_id','admission_source_id', 'tel_3', 'tel_4', 'tel_5', 'tel_6', 'tel_7',
       'tel_8', 'tel_9', 'tel_10', 'tel_11', 'tel_15', 'tel_16', 'tel_17', 'tel_18', 'tel_19', 'tel_21', 'tel_22',
       'tel_23', 'tel_24', 'tel_25', 'tel_26', 'tel_27', 'tel_42', 'tel_43',
       'tel_44', 'tel_49']
...
submit =  pd.merge(dframe1, prediction, how='left', on=['encounter_id'])
